...
// 	//create_Internal_Order_Form : function() {
// 	//	wn.model.open_mapped_doc({
// 	//		method: "selling.doctype.quotation.quotation.make_interl_order",
...
//  	wn.model.open_mapped_doc({
//  		method: "selling.doctype.quotation.quotation.make_internal_order",
//  		source_name: cur_frm.doc.name
//  	})
// }
// // declare order lost
...
cur_frm.cscript.add = function(doc,cdt,cdn){
                 ...
                 if(d.item){
                        get_server_fields('get_accessories_details',d.item,'',doc,cdt,cdn,1,function(r,rt){refresh_field('quotation_details')});
                }
                else
